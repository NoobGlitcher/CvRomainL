...
import com.example.cvromainl.outils.Constants;
...
public class PaiementsUtil {
    ...
    public static JSONObject getPaymentDataRequest(long priceCents) {
        ...
        final String price = PaiementsUtil.centsToString(priceCents);

        try {
            JSONObject paymentDataRequest = PaiementsUtil.getBaseRequest();
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(PaiementsUtil.getCardPaymentMethod()));
            paymentDataRequest.put("transactionInfo", PaiementsUtil.getTransactionInfo(price));
            paymentDataRequest.put("merchantInfo", PaiementsUtil.getMerchantInfo());
    ...
    /**
     * Converts cents to a string format accepted by {@link PaiementsUtil#getPaymentDataRequest}.
     *
