...
import com.example.cvromainl.databinding.ActivityCheckoutBinding;
import com.example.cvromainl.outils.PaiementsUtil;
import com.example.cvromainl.Model.CheckoutViewModel;
        ...
        try {
            googlePayButton.initialize(
                    ButtonOptions.newBuilder()
                            .setAllowedPaymentMethods(PaiementsUtil.getAllowedPaymentMethods().toString()).build()
            );
