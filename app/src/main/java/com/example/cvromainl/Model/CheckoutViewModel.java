...
import com.example.cvromainl.outils.PaiementsUtil;
...
public class CheckoutViewModel extends AndroidViewModel {
    ...
    public CheckoutViewModel(@NonNull Application application) {
        super(application);
        paymentsClient = PaiementsUtil.createPaymentsClient(application);
    ...
    private void fetchCanUseGooglePay() {
        final JSONObject isReadyToPayJson = PaiementsUtil.getIsReadyToPayRequest();
    ...
    public Task<PaymentData> getLoadPaymentDataTask(final long priceCents) {
        JSONObject paymentDataRequestJson = PaiementsUtil.getPaymentDataRequest(priceCents);
